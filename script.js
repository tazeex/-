...
let questions = [
    ...
    {
    numb: 2,
    question: "ქვემოთ ჩამოთვლილ მამაკაც საჰაბეთაგან, რომელს აქვს შუამავლისგან ყველაზე მეტი ჰადისი გადმოცემული?",
    ...
    {
    numb: 3,
    question: "ალლაჰის შუამავალი ბრძანებს: „ პიროვნება, რომელსაც მაძღარი სძინავს და თავისი მეზობელი მშიერია, ჩვენიანი არ არის“-ჰადისი, რომელი ღვთისმსახურების აუცილებლობაზე მიუთითებს?",
    answer: "ა. ზექათი",
    options: [
      "ა. ზექათი",
      "ბ. ლოცვა",
    ...
    {
    numb: 4,
    question: "შუამავლის ჰადისის თანახმად,  რომელი (ყველაზე მნიშვნელოვანი) თვისების მიხედვით უნდა შეარჩიოს მუსლიმმა მეუღლე?",
    ...
    {
    numb: 5,
    question: "ალლაჰის საუკეთესო სახელებიდან, ელ-მუჰეიმინუ’ს მნიშვნელობა რომელია?",
  ...
  {
    numb: 6,
    question: "ალლაჰის ბრძანებით, რომელი შუამავალი იქნა დატოვებული მდინარე ნილოსში?",
    ...
    {
    numb: 10,
    question: "ქვემოთ ჩამოთვლილთაგან, პირმოთნისთვის დამახასიათებელი თვისება რომელია?",
...
function showResult(){
    ...
    if (userScore > 3){ // if user scored more than 3
        ...
        let scoreTag = '<span>გილოცავთ! 🎉თქვენ გაქვთ<p>'+ userScore +'</p>სწორი პასუხი<p>'+ questions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;  //adding new span tag inside score_Text
    }
    else if(userScore > 1){ // if user scored more than 1
        let scoreTag = '<span>სასიამოვნო 😎თქვენ გაქვთ<p>'+ userScore +'</p> სწორი პასუხი<p>'+ questions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;
    }
    else{ // if user scored less than 1
        let scoreTag = '<span>ბოდიში😐 თქვენ გაქვთ მხოლოდ <p>'+ userScore +'</p> სწორი პასუხი<p>'+ questions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;
    }
}
...
function queCounter(index){
    ...
    let totalQueCounTag = '<span><p>'+ index +'</p> -- <p>'+ questions.length +'</p> კითხვა</span>';
